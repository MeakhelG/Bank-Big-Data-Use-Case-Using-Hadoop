...
sqoop job --create sqoop_loan_info -- import --connect jdbc:mysql://localhost/bank 
--username admin --password admin --table loan_info --target-dir /bank/loan_info_stg -m 1
...
--username admin --password admin --table credit_card_info --target-dir /bank/credit_card_info_stg -m 1
...
sqoop job --create sqoop_shares_info -- import --connect jdbc:mysql://localhost/bank 
--username admin --password admin --table shares_info --target-dir /bank/shares_info_stg -m 1
